...
import { z } from 'zod'
import { clientSchema, clientInfoSchema, groupMemberSchema } from '../../../types'

const bodySchema = z.object({})
const querySchema = z.object({
    name: z.string()
})
const responseSchema = z.array(clientSchema.merge(clientInfoSchema).merge(groupMemberSchema))
